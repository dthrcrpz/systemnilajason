        ...
        <div class="col-sm-9" style="margin-left: -10px">
            ...
            <div class="panel panel-default hotelsna">
                <div class="panel-body">
                    ...
                    @if(count($rt->where('hotel_id', $hotel->id)))
                    <span class="glyphicon glyphicon-thumbs-up"></span>
                    {{ $rt->where('hotel_id', $hotel->id)->where('value', '1')->count() }} &nbsp;&nbsp;&nbsp;
                    <span class="glyphicon glyphicon-thumbs-down"></span> {{ $rt->where('hotel_id', $hotel->id)->where('value', '0')->count() }}
                    @endif
                    </font></h5>
