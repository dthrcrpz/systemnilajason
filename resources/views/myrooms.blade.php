...
@section('myrooms')
	<form class="form-inline" id="upload" method="post" action="/myrooms" enctype="multipart/form-data">
		{{ csrf_field() }}
	<div class="row">
	...
	<div class="row">
		...
		<div class="col-sm-3 text-center" style="border: 1px solid white; padding: 3px 3px 3px 3px">
			...
			<p class="text-center" style="margin-top: 5px; background-color: white"><strong>{{ $room->type }}</strong><br><span class="">P {{ $room->price }}</span></p>
